...
export class TransactionResponseDto {
    ...
    @ApiProperty({ description: 'Gas used (wei) as BigInt string', example: '21000', required: false })
    gasUsed?: string | null;

    @ApiProperty({ description: 'Gas fee paid (wei)', example: '2100000000000000', required: false })
    gasFee?: string | null;

    @ApiProperty({ description: 'From address balance after transaction (wei)', example: '1000000000000000000', required: false })
    ...
    @ApiProperty({ description: 'Transaction status (1=success,0=failed)', example: 1, required: false })
    status?: number | null;

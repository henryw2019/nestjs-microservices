...
export class TransferResponseDto {
    ...
    @ApiProperty({ description: 'ERC20 token contract address (if applicable)', example: '0xToken', required: false })
    token?: string;
    ...
    @ApiProperty({ description: 'Gas limit used for the transaction', example: '21000', required: false })
    gasLimit?: string;
}
